# 📄 **Licencia_Español.md — Traducción informativa de la licencia MIT**

**LICENCIA MIT — Traducción no oficial**

**Aviso importante:**  
Este documento es una traducción al castellano de la licencia MIT.  
La licencia legalmente vinculante es la versión original en inglés incluida en el archivo `LICENSE`.

---

**Copyright (c) 2026 Pedro**

Por la presente se concede permiso, de manera gratuita, a cualquier persona que obtenga una copia de este software y de los archivos de documentación asociados (el “Software”), para usar el Software sin restricción, incluyendo sin limitación los derechos de usar, copiar, modificar, fusionar, publicar, distribuir, sublicenciar y/o vender copias del Software, y permitir a las personas a las que se les proporcione el Software que hagan lo mismo, sujeto a las siguientes condiciones:
...
https://github.com/pelloweb/AVD/blob/main/LICENSE
