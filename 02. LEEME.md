...
Puedes ver la estructura completa aquí:
...
> ⚠️ **Aviso de Transparencia sobre IA:** Este proyecto fue desarrollado bajo la plena dirección, supervisión y responsabilidad final de **Pelloweb**. Se utilizaron herramientas de IA como asistencia para tareas como la estructuración del código, la redacción y la documentación. Todo el contenido final ha sido revisado, validado y curado por autoría humana, en alineación con los principios de transparencia del Reglamento de IA de la UE.
